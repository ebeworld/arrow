...
set(stdout_log "/Users/bytedance/cpp/arrow/cpp/build-debug/gbenchmark_ep-prefix/src/gbenchmark_ep-stamp/gbenchmark_ep-install-out.log")
set(stderr_log "/Users/bytedance/cpp/arrow/cpp/build-debug/gbenchmark_ep-prefix/src/gbenchmark_ep-stamp/gbenchmark_ep-install-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /Users/bytedance/cpp/arrow/cpp/build-debug/gbenchmark_ep-prefix/src/gbenchmark_ep-stamp/gbenchmark_ep-install-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "gbenchmark_ep install command succeeded.  See also /Users/bytedance/cpp/arrow/cpp/build-debug/gbenchmark_ep-prefix/src/gbenchmark_ep-stamp/gbenchmark_ep-install-*.log")
    message(STATUS "${msg}")
  endif()
endif()
