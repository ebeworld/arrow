...
set(stdout_log "/Users/bytedance/cpp/arrow/cpp/build-debug/gbenchmark_ep-prefix/src/gbenchmark_ep-stamp/gbenchmark_ep-build-out.log")
set(stderr_log "/Users/bytedance/cpp/arrow/cpp/build-debug/gbenchmark_ep-prefix/src/gbenchmark_ep-stamp/gbenchmark_ep-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /Users/bytedance/cpp/arrow/cpp/build-debug/gbenchmark_ep-prefix/src/gbenchmark_ep-stamp/gbenchmark_ep-build-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "gbenchmark_ep build command succeeded.  See also /Users/bytedance/cpp/arrow/cpp/build-debug/gbenchmark_ep-prefix/src/gbenchmark_ep-stamp/gbenchmark_ep-build-*.log")
    message(STATUS "${msg}")
  endif()
endif()
