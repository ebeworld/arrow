...
HuluRpcRequestMeta::HuluRpcRequestMeta(const HuluRpcRequestMeta& from)
  ...
  HuluRpcRequestMeta* const _this = this; (void)_this;
  new (&_impl_) Impl_{
  ...
  if (from._internal_has_credential_data()) {
    _this->_impl_.credential_data_.Set(from._internal_credential_data(), 
      _this->GetArenaForAllocation());
  }
  if (from._internal_has_chuck_info()) {
    _this->_impl_.chuck_info_ = new ::brpc::ChunkInfo(*from._impl_.chuck_info_);
  }
...
void HuluRpcRequestMeta::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<HuluRpcRequestMeta*>(&to_msg);
  auto& from = static_cast<const HuluRpcRequestMeta&>(from_msg);
  ...
  if (cached_has_bits & 0x000000ffu) {
    ...
    if (cached_has_bits & 0x00000008u) {
      _this->_internal_set_credential_data(from._internal_credential_data());
    }
    if (cached_has_bits & 0x00000010u) {
      _this->_internal_mutable_chuck_info()->::brpc::ChunkInfo::MergeFrom(
          from._internal_chuck_info());
    }
    if (cached_has_bits & 0x00000020u) {
  ...
  if (cached_has_bits & 0x00007f00u) {
    ...
    if (cached_has_bits & 0x00001000u) {
      _this->_impl_.request_talk_type_ = from._impl_.request_talk_type_;
    }
    if (cached_has_bits & 0x00002000u) {
      _this->_impl_.user_message_size_ = from._impl_.user_message_size_;
    }
    if (cached_has_bits & 0x00004000u) {
      _this->_impl_.user_defined_source_addr_ = from._impl_.user_defined_source_addr_;
    }
    _this->_impl_._has_bits_[0] |= cached_has_bits;
  }
...
HuluRpcResponseMeta::HuluRpcResponseMeta(const HuluRpcResponseMeta& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  HuluRpcResponseMeta* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
...
void HuluRpcResponseMeta::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<HuluRpcResponseMeta*>(&to_msg);
  auto& from = static_cast<const HuluRpcResponseMeta&>(from_msg);
  ...
  if (cached_has_bits & 0x000000ffu) {
    ...
    if (cached_has_bits & 0x00000040u) {
      _this->_impl_.response_talk_type_ = from._impl_.response_talk_type_;
    }
    if (cached_has_bits & 0x00000080u) {
      _this->_impl_.user_message_size_ = from._impl_.user_message_size_;
    }
  ...
  if (cached_has_bits & 0x00000100u) {
    _this->_internal_set_user_defined_source_addr(from._internal_user_defined_source_addr());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
