...
RpcMeta::RpcMeta(const RpcMeta& from)
  ...
  if (from._internal_has_authentication_data()) {
    _this->_impl_.authentication_data_.Set(from._internal_authentication_data(), 
      _this->GetArenaForAllocation());
  }
  if (from._internal_has_request()) {
    _this->_impl_.request_ = new ::brpc::policy::RpcRequestMeta(*from._impl_.request_);
  }
  if (from._internal_has_response()) {
    _this->_impl_.response_ = new ::brpc::policy::RpcResponseMeta(*from._impl_.response_);
  }
  if (from._internal_has_chunk_info()) {
    _this->_impl_.chunk_info_ = new ::brpc::ChunkInfo(*from._impl_.chunk_info_);
  }
  if (from._internal_has_stream_settings()) {
    _this->_impl_.stream_settings_ = new ::brpc::StreamSettings(*from._impl_.stream_settings_);
  }
...
void RpcMeta::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (cached_has_bits & 0x000000ffu) {
    if (cached_has_bits & 0x00000001u) {
      _this->_internal_set_authentication_data(from._internal_authentication_data());
    }
    if (cached_has_bits & 0x00000002u) {
      _this->_internal_mutable_request()->::brpc::policy::RpcRequestMeta::MergeFrom(
          from._internal_request());
    }
    if (cached_has_bits & 0x00000004u) {
      _this->_internal_mutable_response()->::brpc::policy::RpcResponseMeta::MergeFrom(
          from._internal_response());
    }
    if (cached_has_bits & 0x00000008u) {
      _this->_internal_mutable_chunk_info()->::brpc::ChunkInfo::MergeFrom(
          from._internal_chunk_info());
    }
    if (cached_has_bits & 0x00000010u) {
      _this->_internal_mutable_stream_settings()->::brpc::StreamSettings::MergeFrom(
    ...
    if (cached_has_bits & 0x00000080u) {
      _this->_impl_.attachment_size_ = from._impl_.attachment_size_;
    }
...
RpcRequestMeta::RpcRequestMeta(const RpcRequestMeta& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  RpcRequestMeta* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
...
void RpcRequestMeta::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<RpcRequestMeta*>(&to_msg);
  auto& from = static_cast<const RpcRequestMeta&>(from_msg);
...
RpcResponseMeta::RpcResponseMeta(const RpcResponseMeta& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  RpcResponseMeta* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
...
void RpcResponseMeta::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<RpcResponseMeta*>(&to_msg);
  auto& from = static_cast<const RpcResponseMeta&>(from_msg);
