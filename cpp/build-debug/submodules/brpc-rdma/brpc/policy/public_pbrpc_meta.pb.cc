...
PublicPbrpcRequest::PublicPbrpcRequest(const PublicPbrpcRequest& from)
  ...
  PublicPbrpcRequest* const _this = this; (void)_this;
  new (&_impl_) Impl_{
  ...
  if (from._internal_has_requesthead()) {
    _this->_impl_.requesthead_ = new ::brpc::policy::RequestHead(*from._impl_.requesthead_);
  }
...
void PublicPbrpcRequest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<PublicPbrpcRequest*>(&to_msg);
  auto& from = static_cast<const PublicPbrpcRequest&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:brpc.policy.PublicPbrpcRequest)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;

  _this->_impl_.requestbody_.MergeFrom(from._impl_.requestbody_);
  if (from._internal_has_requesthead()) {
    _this->_internal_mutable_requesthead()->::brpc::policy::RequestHead::MergeFrom(
        from._internal_requesthead());
  }
...
RequestHead::RequestHead(const RequestHead& from)
  ...
  if (from._internal_has_from_host()) {
    _this->_impl_.from_host_.Set(from._internal_from_host(), 
  ...
  if (from._internal_has_accept_charset()) {
    _this->_impl_.accept_charset_.Set(from._internal_accept_charset(), 
      _this->GetArenaForAllocation());
  }
...
void RequestHead::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (cached_has_bits & 0x000000ffu) {
    if (cached_has_bits & 0x00000001u) {
      _this->_internal_set_from_host(from._internal_from_host());
    }
    if (cached_has_bits & 0x00000002u) {
      _this->_internal_set_charset(from._internal_charset());
    }
    if (cached_has_bits & 0x00000004u) {
      _this->_internal_set_accept_charset(from._internal_accept_charset());
    }
    if (cached_has_bits & 0x00000008u) {
...
RequestBody::RequestBody(const RequestBody& from)
  ...
  if (from._internal_has_serialized_request()) {
    _this->_impl_.serialized_request_.Set(from._internal_serialized_request(), 
      _this->GetArenaForAllocation());
  }
...
PublicPbrpcResponse::PublicPbrpcResponse(const PublicPbrpcResponse& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  PublicPbrpcResponse* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
  ...
  if (from._internal_has_responsehead()) {
    _this->_impl_.responsehead_ = new ::brpc::policy::ResponseHead(*from._impl_.responsehead_);
  }
...
void PublicPbrpcResponse::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<PublicPbrpcResponse*>(&to_msg);
  auto& from = static_cast<const PublicPbrpcResponse&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:brpc.policy.PublicPbrpcResponse)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;

  _this->_impl_.responsebody_.MergeFrom(from._impl_.responsebody_);
  if (from._internal_has_responsehead()) {
    _this->_internal_mutable_responsehead()->::brpc::policy::ResponseHead::MergeFrom(
        from._internal_responsehead());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
ResponseBody::ResponseBody(const ResponseBody& from)
  ...
  if (from._internal_has_serialized_response()) {
    _this->_impl_.serialized_response_.Set(from._internal_serialized_response(), 
      _this->GetArenaForAllocation());
  }
  _impl_.version_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
void ResponseBody::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (cached_has_bits & 0x0000000fu) {
    if (cached_has_bits & 0x00000001u) {
      _this->_internal_set_serialized_response(from._internal_serialized_response());
    }
    if (cached_has_bits & 0x00000002u) {
      _this->_internal_set_version(from._internal_version());
    }
