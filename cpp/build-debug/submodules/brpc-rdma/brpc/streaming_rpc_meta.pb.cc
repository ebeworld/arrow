...
StreamSettings::StreamSettings(const StreamSettings& from)
  ...
  StreamSettings* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
void StreamSettings::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<StreamSettings*>(&to_msg);
  auto& from = static_cast<const StreamSettings&>(from_msg);
  ...
  if (cached_has_bits & 0x00000007u) {
    ...
    if (cached_has_bits & 0x00000002u) {
      _this->_impl_.need_feedback_ = from._impl_.need_feedback_;
    }
    if (cached_has_bits & 0x00000004u) {
...
StreamFrameMeta::StreamFrameMeta(const StreamFrameMeta& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  StreamFrameMeta* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.feedback_){nullptr}
  ...
  if (from._internal_has_feedback()) {
    _this->_impl_.feedback_ = new ::brpc::Feedback(*from._impl_.feedback_);
  }
  ::memcpy(&_impl_.stream_id_, &from._impl_.stream_id_,
...
void StreamFrameMeta::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<StreamFrameMeta*>(&to_msg);
  auto& from = static_cast<const StreamFrameMeta&>(from_msg);
  ...
  if (cached_has_bits & 0x0000001fu) {
    if (cached_has_bits & 0x00000001u) {
      _this->_internal_mutable_feedback()->::brpc::Feedback::MergeFrom(
    ...
    if (cached_has_bits & 0x00000004u) {
      _this->_impl_.source_stream_id_ = from._impl_.source_stream_id_;
    }
    if (cached_has_bits & 0x00000008u) {
      _this->_impl_.frame_type_ = from._impl_.frame_type_;
    }
    if (cached_has_bits & 0x00000010u) {
      _this->_impl_.has_continuation_ = from._impl_.has_continuation_;
    }
    _this->_impl_._has_bits_[0] |= cached_has_bits;
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
...
Feedback::Feedback(const Feedback& from)
  ...
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  _this->_impl_.consumed_size_ = from._impl_.consumed_size_;
...
void Feedback::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_has_consumed_size()) {
    _this->_internal_set_consumed_size(from._internal_consumed_size());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
