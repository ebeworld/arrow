...
TrackMeRequest::TrackMeRequest(const TrackMeRequest& from)
  ...
  TrackMeRequest* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
void TrackMeRequest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<TrackMeRequest*>(&to_msg);
  auto& from = static_cast<const TrackMeRequest&>(from_msg);
...
TrackMeResponse::TrackMeResponse(const TrackMeResponse& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  TrackMeResponse* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
...
void TrackMeResponse::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<TrackMeResponse*>(&to_msg);
  auto& from = static_cast<const TrackMeResponse&>(from_msg);
  ...
  if (cached_has_bits & 0x00000007u) {
    ...
    if (cached_has_bits & 0x00000004u) {
      _this->_impl_.new_interval_ = from._impl_.new_interval_;
    }
    _this->_impl_._has_bits_[0] |= cached_has_bits;
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
