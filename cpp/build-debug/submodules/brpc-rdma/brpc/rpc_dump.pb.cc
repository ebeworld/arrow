...
RpcDumpMeta::RpcDumpMeta(const RpcDumpMeta& from)
  ...
  RpcDumpMeta* const _this = this; (void)_this;
  new (&_impl_) Impl_{
  ...
  if (from._internal_has_nshead()) {
    _this->_impl_.nshead_.Set(from._internal_nshead(), 
      _this->GetArenaForAllocation());
  }
...
void RpcDumpMeta::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<RpcDumpMeta*>(&to_msg);
  auto& from = static_cast<const RpcDumpMeta&>(from_msg);
  ...
  if (cached_has_bits & 0x000000ffu) {
    ...
    if (cached_has_bits & 0x00000010u) {
      _this->_internal_set_nshead(from._internal_nshead());
    }
    if (cached_has_bits & 0x00000020u) {
  ...
  if (cached_has_bits & 0x00000100u) {
    _this->_internal_set_attachment_size(from._internal_attachment_size());
  }
