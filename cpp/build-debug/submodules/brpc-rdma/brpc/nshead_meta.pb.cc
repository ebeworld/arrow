...
NsheadMeta::NsheadMeta(const NsheadMeta& from)
  ...
  NsheadMeta* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
void NsheadMeta::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<NsheadMeta*>(&to_msg);
  auto& from = static_cast<const NsheadMeta&>(from_msg);
